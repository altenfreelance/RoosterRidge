  ...
  return (
    ...
    <div>
      ...
      <div className="row">
        ...
        {sortedEvents.length === 0 && <p className="container-fluid" style={{ margin: "auto" }}>We don't have any public shows on the books for now. Please see our <a href="/contact">contact</a> page if you are interested in booking Rooster Ridge.</p>}
      </div>
    </div>
  );
}
